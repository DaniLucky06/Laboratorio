...
h = histogram(g_25_vet, 'BinMethod', 'fd', 'Normalization', 'pdf');
...
h = histogram(g_45_vet, 'BinMethod', 'fd', 'Normalization', 'pdf');
...
h = histogram(g_65_vet, 'BinMethod', 'fd', 'Normalization', 'pdf');
...
h1 = histogram(g_25_vet, 'BinMethod', 'fd', 'Normalization', 'pdf');
h2 = histogram(g_45_vet, 'BinMethod', 'fd', 'Normalization', 'pdf', 'FaceColor', 'r', 'FaceAlpha', 0.5);
h3 = histogram(g_65_vet, 'BinMethod', 'fd', 'Normalization', 'pdf', 'FaceColor', 'g', 'FaceAlpha', 0.5);
...
% Calcolo della curva Gaussiana pura (PDF)
x_fit = linspace(min_bin - margine_x, max_bin + margine_x, 1000);
y_fit = (1 / (dev_std_g(1) * sqrt(2*pi))) * exp(-0.5 * ((x_fit - g_med(1)) / dev_std_g(1)).^2);
...
% Calcolo della curva Gaussiana pura (PDF)
x_fit = linspace(min_bin - margine_x, max_bin + margine_x, 1000);
y_fit = (1 / (dev_std_g(2) * sqrt(2*pi))) * exp(-0.5 * ((x_fit - g_med(2)) / dev_std_g(2)).^2);
plot(x_fit, y_fit, 'Color', 'b', 'LineWidth', 2);
...
% Calcolo della curva Gaussiana pura (PDF)
x_fit = linspace(min_bin - margine_x, max_bin + margine_x, 1000);
y_fit = (1 / (dev_std_g(3) * sqrt(2*pi))) * exp(-0.5 * ((x_fit - g_med(3)) / dev_std_g(3)).^2);
plot(x_fit, y_fit, 'Color', 'b', 'LineWidth', 2);
...
% Calcolo della curva Gaussiana pura (PDF) per i tre angoli
x_fit = linspace(min_bin - margine_x, max_bin + margine_x, 1000);
y_fit1 = (1 / (dev_std_g(1) * sqrt(2*pi))) * exp(-0.5 * ((x_fit - g_med(1)) / dev_std_g(1)).^2);
y_fit2 = (1 / (dev_std_g(2) * sqrt(2*pi))) * exp(-0.5 * ((x_fit - g_med(2)) / dev_std_g(2)).^2);
y_fit3 = (1 / (dev_std_g(3) * sqrt(2*pi))) * exp(-0.5 * ((x_fit - g_med(3)) / dev_std_g(3)).^2);
